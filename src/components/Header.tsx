        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center gap-6">
              ...
              <a href="#" className="text-sm hover:text-primary transition-colors">Fachada</a>
              <a href="#" className="text-sm hover:text-primary transition-colors">Nossa Lojas</a>
              <a href="#" className="text-sm hover:text-primary transition-colors">Quem somos</a>
              <a href="#services" className="text-sm hover:text-primary transition-colors">Serviços</a>
              <a href="#" className="text-sm hover:text-primary transition-colors">Projetos</a>
              <a href="#" className="text-sm hover:text-primary transition-colors">Clientes</a>
